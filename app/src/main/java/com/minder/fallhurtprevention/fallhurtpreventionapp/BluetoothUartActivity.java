...
public class BluetoothUartActivity extends Activity implements BluetoothLeUart.Callback {

    // UI elements
    private TextView messages;
    private EditText input;
    private Button   send;    private CheckBox newline;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_uart);
    ...
    public void onDeviceFound(BluetoothDevice device) {
        ...
        writeLine("device uuid : "  + device.getUuids());
